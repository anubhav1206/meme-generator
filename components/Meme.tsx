...
const Meme = () => {
  ...
  return (
    <div>
      ...
      <button
        className="button flex mx-auto text-memeViolet active:bg-violet-700 font-bold py-3 border cursor-pointer border-gray-200 text-lg md:text-xl rounded-lg px-12 mt-6 md:px-36"
